          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {softCareArsenal.map((product, i) => (
              ...
              >
                ...
                <div className="relative flex-1 bg-slate-900/40 backdrop-blur-3xl rounded-[3.5rem] border border-white/5 overflow-hidden flex flex-col shadow-2xl transition-all duration-500 group-hover:border-violet-500/30 group-hover:shadow-violet-500/10">
                  ...
                  <div className="h-80 relative overflow-hidden bg-[#020617]">
                    ...
                    <div className="absolute bottom-6 left-8">
                      <span className="text-[10px] font-black uppercase tracking-widest text-white/50 bg-white/5 px-4 py-2 rounded-full border border-white/10 backdrop-blur-xl group-hover:text-violet-400 group-hover:border-violet-500/30 transition-all">
                        {product.brand}
                      </span>
                    </div>
                    ...
                    <div className="absolute top-8 right-8">
                      <div className="px-5 py-2 rounded-full bg-[#020617]/80 backdrop-blur-md text-white font-black text-[11px] uppercase border border-white/10 shadow-2xl group-hover:border-violet-500/50 transition-colors">
                        {product.price}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-10 flex flex-col flex-1 relative z-10">
                    <div className="mb-6">
                      <span className="text-[10px] font-black uppercase tracking-[0.3em] text-violet-500/60 mb-4 block">{product.tag}</span>
                      <h3 className="text-3xl font-display font-black uppercase text-white mb-4 leading-tight group-hover:text-violet-400 transition-colors">
                        {product.name}
                      </h3>
                    ...
                    <div className="mt-auto pt-8 border-t border-white/5 flex items-center justify-between">
                      ...
                      <a 
                        ...
                        className="group/btn flex items-center gap-3 text-white font-black text-[10px] uppercase tracking-[0.2em] bg-violet-600 px-6 py-3 rounded-2xl hover:bg-white hover:text-black transition-all shadow-xl"
                      >
                ...
                <div className="absolute -inset-4 bg-violet-500/0 group-hover:bg-violet-500/5 rounded-[4rem] blur-2xl transition-all duration-700 -z-10"></div>
              </motion.div>
            ))}
          </div>
        </section>
