...
export default function NutritionPillar() {
  ...
  useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute('content', t('np_description'));
    }
  }, [t]);
      ...
      <div className="relative pt-32 pb-48 md:pt-48 md:pb-72 flex items-center justify-center overflow-hidden">
        ...
        >
          <img
            ...
            alt="Metabolic Precision and Nutragenomics"
        ...
        <motion.div 
          ...
          className="absolute top-1/4 -right-20 w-[42rem] h-[42rem] bg-emerald-600 rounded-full blur-[150px] pointer-events-none"
        />
        <motion.div 
          animate={{ 
            scale: [1.2, 1, 1.2],
          ...
          className="absolute -bottom-20 -left-20 w-[32rem] h-[32rem] bg-teal-500 rounded-full blur-[120px] pointer-events-none"
        />

        {/* Technical Data Grid Overlay */}
        <div className="absolute inset-0 opacity-[0.05] pointer-events-none" 
             style={{ backgroundImage: "radial-gradient(circle at 2px 2px, #10b981 1px, transparent 0)", backgroundSize: "52px 52px" }}>
        </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Link to="/#pillars" className="absolute -top-32 left-4 sm:left-6 lg:left-8 inline-flex items-center text-white/40 hover:text-white font-black uppercase tracking-tighter transition-all group">
            ...
            <span className="border-b border-white/10 group-hover:border-white">{t('np_back')}</span>
          </Link>
          ...
          >
            <motion.div 
              ...
              animate={{ scale: 1 }}
              transition={{ duration: 1 }}
              className="inline-flex items-center px-6 py-2 rounded-full bg-white/5 border border-white/10 text-emerald-400 font-display font-black text-[10px] uppercase tracking-[0.3em] mb-12 shadow-2xl backdrop-blur-md"
            >
              <Droplets size={14} className="mr-3 animate-pulse" />
              Metabolic Flux: Balanced
            </motion.div>
            ...
            <motion.p 
              ...
              className="text-xl md:text-2xl text-slate-400 font-medium max-w-4xl mx-auto leading-relaxed border-l-4 border-emerald-500/50 pl-8 text-left"
            >
              {t('np_description')} In 2026, nutrition is **precision signal engineering**. We optimize for autophagy, insulin sensitivity, and SIRT1-driven cellular repair.
            </motion.p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 -mt-24 pb-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-40">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 bg-white/5 rounded-3xl flex items-center justify-center text-emerald-400 mb-10 border border-white/10 group-hover:scale-110 transition-transform duration-500">
                <Microscope size={32} />
              </div>
              ...
              <div className="p-8 bg-white/5 rounded-[2.5rem] border border-white/5 mb-10">
                 <h4 className="text-[10px] font-black uppercase tracking-widest text-emerald-400 mb-4 flex items-center gap-2">
                   <Dna size={14} /> Epigenetic Fueling
                 </h4>
                 <p className="text-sm text-slate-500 leading-relaxed font-medium">Nutrigenomics identifies how specific phytonutrients interact with your individual genetic expression to silence inflammation and trigger repair.</p>
              </div>
            </div>
            <div className="flex items-center gap-3 text-emerald-400 font-bold text-[10px] uppercase tracking-[0.2em] border-t border-white/5 pt-10">
              <Zap size={16} />
              The Biomarker Protocol
            </div>
          </motion.div>
          ...
          >
            <div className="relative z-10">
              <div className="w-16 h-16 bg-white/5 rounded-3xl flex items-center justify-center text-teal-400 mb-10 border border-white/10 group-hover:scale-110 transition-transform duration-500">
                <BarChart3 size={32} />
              </div>
              ...
              <div className="space-y-4 pt-10 border-t border-white/5">
                {[
                  ...
                  { label: "Glucose Stability", value: "98%" },
                  { label: "Post-Prandial Lag", value: "Minimal" }
                ].map((stat, i) => (
                  <div key={i} className="flex justify-between items-center py-2">
                    <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500">{stat.label}</span>
                    <span className="text-sm font-bold text-white">{stat.value}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="flex items-center gap-3 text-teal-400 font-bold text-[10px] uppercase tracking-[0.2em] pt-10 relative z-10">
              <Activity size={16} />
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
              <div className="lg:col-span-12 mb-16 text-center">
                <div className="inline-flex items-center gap-4 text-emerald-400 font-black uppercase tracking-widest text-[10px] bg-emerald-500/10 px-6 py-2 rounded-full border border-emerald-500/20 mb-8">
                  <Target size={14} />
                  Precision Glycemic Optimization
                </div>
                ...
                <p className="text-xl md:text-2xl text-slate-400 leading-relaxed font-medium max-w-4xl mx-auto">
                  {t('np_med_desc')} A foundational operating system for metabolic longevity.
                </p>
              </div>
              ...
              <div className="lg:col-span-5">
                <div className="bg-slate-950 p-12 rounded-[4rem] border border-white/10 shadow-2xl relative overflow-hidden h-full">
                  <div className="absolute top-0 right-0 p-8 opacity-10">
                    <FlaskConical size={120} className="text-emerald-400" />
                  </div>
                  <div className="relative z-10 space-y-10">
                    <h3 className="text-2xl font-display font-black uppercase text-emerald-400">Tactical Control</h3>
                    
                    <div className="space-y-6">
                      {[
                        { key: 'np_cta_age_us', link: affiliateLinks.insidetracker, label: 'Bio-Analysis' },
                        { key: 'np_cta_nad', link: affiliateLinks.thorne, label: 'SIRT1 activation' },
                        { key: 'np_cta_creatine_brain', link: affiliateLinks.us, label: 'ATP Regeneration' },
                        { key: 'np_cta_supps', link: affiliateLinks.thorne, label: 'Clinical Stack' }
                      ].map((cta, i) => (
        ...
        <section className="mb-40 pt-20">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20 px-4">
            <div className="space-y-4">
              <span className="text-emerald-500 font-black uppercase tracking-[0.3em] text-xs">Clinical Arsenal</span>
            ...
            <p className="text-slate-500 font-bold uppercase tracking-widest text-xs border-b border-emerald-500/20 pb-4">
              Vetted 2026 Nutrition Tier-1 Tools
            </p>
          </div>
            ...
            {pillarEssentials.map((product, i) => (
              ...
              >
                ...
                <div className="p-10 flex flex-col flex-1">
                  <h3 className="text-2xl font-display font-black uppercase text-white mb-4 group-hover:text-emerald-400 transition-colors">
                    {product.name}
                  </h3>
        ...
        <div className="space-y-48">
          ...
          <div className="relative">
            ...
            <BlogSection category="nutrition" limit={12} />
          </div>
        </div>
      </div>
    </div>
