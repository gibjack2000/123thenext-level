      ...
      <div className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
          ...
          <motion.div 
            ...
            className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-purple-500/20 backdrop-blur-xl border border-purple-500/30 text-purple-400 mb-6 mx-auto"
          >
            <Sparkles size={40} />
          </motion.div>
          <motion.h1 
