...
<div class="clinical-svg-infographic my-8 p-4 sm:p-6 rounded-2xl border border-slate-800 bg-slate-950/90 shadow-2xl overflow-hidden backdrop-blur-md">
  ...
  <div style="margin-bottom: 0.75rem;">
    <h4 style="margin: 0 0 0.25rem 0; font-size: 1rem; font-weight: 800; color: #f8fafc; font-family: ''Outfit'', sans-serif; letter-spacing: -0.01em;">Continuous Biometric Telemetry Architecture</h4>
    <p style="margin: 0; font-size: 0.8rem; color: #94a3b8;">Multi-stream sensor pipeline mapping real-time internal load vs external wattage output.</p>
  </div>
...
<div class="clinical-svg-infographic my-8 p-4 sm:p-6 rounded-2xl border border-slate-800 bg-slate-950/90 shadow-2xl overflow-hidden backdrop-blur-md">
  ...
  <div style="margin-bottom: 0.75rem;">
    <h4 style="margin: 0 0 0.25rem 0; font-size: 1rem; font-weight: 800; color: #f8fafc; font-family: ''Outfit'', sans-serif; letter-spacing: -0.01em;">Lactate Dynamics & Physiological Zones Waveform</h4>
    <p style="margin: 0; font-size: 0.8rem; color: #94a3b8;">Biochemical lactate kinetics identifying the exact LT1 aerobic threshold and LT2 anaerobic threshold.</p>
  </div>
  <div style="width: 100%; overflow-x: auto;">
    <svg viewBox="0 0 800 280" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" style="display: block; min-width: 600px; max-width: 100%;">
      <defs>
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Concept2 Remo Indoor Model D Rower</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Gold-standard aerobic power, low-impact lactate intervals, and stroke-by-stroke power telemetry for high-output physical longevity.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          ...
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$990.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£850.00 / 950€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B099KBD9X8?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Apple Watch Series 10 (GPS 46mm)</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Multispectral wrist telemetry capturing continuous HRV RMSSD, ECG rhythm confirmation, wrist temperature fluctuations, and sleep architecture.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$399.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£379.00 / 399€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B0DGJG692K?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">ALLTEST 10-Parameter Urinary Reagent Strips</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Instant 2-minute biochemical screen tracking hydration status, specific gravity, urine ketones, and renal micro-albuminuria during heavy training.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$14.99 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£12.99 / 14,99€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B0BS1QCFHX?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="clinical-svg-infographic my-8 p-4 sm:p-6 rounded-2xl border border-slate-800 bg-slate-950/90 shadow-2xl overflow-hidden backdrop-blur-md">
  ...
  <div style="margin-bottom: 0.75rem;">
    <h4 style="margin: 0 0 0.25rem 0; font-size: 1rem; font-weight: 800; color: #f8fafc; font-family: ''Outfit'', sans-serif; letter-spacing: -0.01em;">Cellular Longevity & Epigenetic Transduction Cascade</h4>
    <p style="margin: 0; font-size: 0.8rem; color: #94a3b8;">Upstream hormetic triggers driving enzymatic longevity switches and systemic rejuvenation phenotypes.</p>
  </div>
  <div style="width: 100%; overflow-x: auto;">
    <svg viewBox="0 0 800 280" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" style="display: block; min-width: 600px; max-width: 100%;">
      <defs>
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Personalized Cellular Biomarker Map (56 Biomarkers)</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Comprehensive 56-biomarker diagnostic blood panel measuring hs-CRP, ApoB, fasting insulin, HbA1c, homocysteine, and metabolic longevity.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$299.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£149.00 / 149€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.healthlabs.com/?affiliate=123znl" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Momentous Sirtuin Activation Stack</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Cellular resilience complex formulated with NAD+ precursors, trans-resveratrol, quercetin, and apigenin for mitochondrial biogenesis.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$89.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£79.99 / 89,95€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://livemomentous.com/modernwisdom?code=modernwisdom" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Withings Body Scan Segmental Composition Scale</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Clinical-grade bioelectrical impedance analysis segmentally measuring visceral fat, muscle mass per limb, and vascular age.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$399.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£349.99 / 399,95€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B0B9849CD1?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="clinical-svg-infographic my-8 p-4 sm:p-6 rounded-2xl border border-slate-800 bg-slate-950/90 shadow-2xl overflow-hidden backdrop-blur-md">
  ...
  <div style="margin-bottom: 0.75rem;">
    <h4 style="margin: 0 0 0.25rem 0; font-size: 1rem; font-weight: 800; color: #f8fafc; font-family: ''Outfit'', sans-serif; letter-spacing: -0.01em;">Glycemic Dynamics & Postprandial Excursions</h4>
    <p style="margin: 0; font-size: 0.8rem; color: #94a3b8;">Comparison between isolated refined carbohydrates vs clinical meal-sequenced metabolic curves.</p>
  </div>
  <div style="width: 100%; overflow-x: auto;">
    <svg viewBox="0 0 800 280" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" style="display: block; min-width: 600px; max-width: 100%;">
      <defs>
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Continuous Glucose Monitor (Abbott Lingo / Dexcom ONE+)</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Real-time interstitial glucose telemetry mapping glycemic spikes, insulin sensitivity, and postprandial excursions with millisecond precision.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$89.00/mo <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£79.00 / 79€/mo)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B0DGHQ2QH6?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Zebora Marine Collagen Peptides Powder</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Enzymatically hydrolyzed marine collagen peptides fortified with hyaluronic acid and biotin for gut mucosa integrity and joint repair.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$28.99 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£24.99 / 27,99€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B07T8H5N1M?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Owala FreeSip Insulated Water Bottle</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Patented FreeSip 24-hour temperature-retaining hydration system for optimal cellular electrolyte delivery and fluid volume balance.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$27.99 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£22.99 / 26,99€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B08524B5C6?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
            <span>Buy on Amazon</span>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
          </a>
          <a href="https://123thenextlevel.com/store" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(15, 23, 42, 0.8); color: #cbd5e1; border: 1px solid rgba(255, 255, 255, 0.12); padding: 0.6rem 1.1rem; border-radius: 0.6rem; font-weight: 600; font-size: 0.825rem; text-decoration: none; transition: all 0.2s ease;">
...
<div class="clinical-svg-infographic my-8 p-4 sm:p-6 rounded-2xl border border-slate-800 bg-slate-950/90 shadow-2xl overflow-hidden backdrop-blur-md">
  ...
  <div style="margin-bottom: 0.75rem;">
    <h4 style="margin: 0 0 0.25rem 0; font-size: 1rem; font-weight: 800; color: #f8fafc; font-family: ''Outfit'', sans-serif; letter-spacing: -0.01em;">Autonomic Nervous System Polyvagal Modulation Loop</h4>
    <p style="margin: 0; font-size: 0.8rem; color: #94a3b8;">Bi-directional somato-visceral neural circuits regulating vagal deceleration and systemic anti-inflammatory cascades.</p>
  </div>
  <div style="width: 100%; overflow-x: auto;">
    <svg viewBox="0 0 800 280" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" style="display: block; min-width: 600px; max-width: 100%;">
      <defs>
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Withings BPM Connect Wi-Fi Blood Pressure Cuff</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Medically validated Wi-Fi blood pressure and heart rate monitor instantly synchronizing cardiovascular tone trends and baroreflex response.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$99.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£89.99 / 99,95€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B07SJV1HNR?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
            <span>Buy on Amazon</span>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
          </a>
          <a href="https://123thenextlevel.com/store" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(15, 23, 42, 0.8); color: #cbd5e1; border: 1px solid rgba(255, 255, 255, 0.12); padding: 0.6rem 1.1rem; border-radius: 0.6rem; font-weight: 600; font-size: 0.825rem; text-decoration: none; transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Sony WH-CH720N Noise-Canceling Headphones</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Active acoustic isolation engineered for vagal sensory resets, binaural beat entrainment, and parasympathetic neuromodulation.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$149.99 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£119.00 / 129€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B0BTY3Y6PP?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
            <span>View on Amazon</span>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
          </a>
          <a href="https://123thenextlevel.com/store" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(15, 23, 42, 0.8); color: #cbd5e1; border: 1px solid rgba(255, 255, 255, 0.12); padding: 0.6rem 1.1rem; border-radius: 0.6rem; font-weight: 600; font-size: 0.825rem; text-decoration: none; transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Portable Full-Body Infrared Sauna Tent</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Deep far-infrared thermal hyperthermia sanctuary triggering heat-shock protein expression and parasympathetic autonomic rebound.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$249.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£199.99 / 229€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B08H23V7S5?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">basaho Classic Zafu Meditation Cushion</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Ergonomic buckwheat-filled zafu cushion aligning the spine to facilitate unconstrained diaphragmatic excursion and vagal tone.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$35.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£29.99 / 34,99€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B01697W160?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="clinical-svg-infographic my-8 p-4 sm:p-6 rounded-2xl border border-slate-800 bg-slate-950/90 shadow-2xl overflow-hidden backdrop-blur-md">
  ...
  <div style="margin-bottom: 0.75rem;">
    <h4 style="margin: 0 0 0.25rem 0; font-size: 1rem; font-weight: 800; color: #f8fafc; font-family: ''Outfit'', sans-serif; letter-spacing: -0.01em;">28-Day Infradian Hormonal Waveform & Biomarker Peaks</h4>
    <p style="margin: 0; font-size: 0.8rem; color: #94a3b8;">Estradiol, Luteinizing Hormone (LH), and Progesterone fluctuations across the four infradian biological phases.</p>
  </div>
  <div style="width: 100%; overflow-x: auto;">
    <svg viewBox="0 0 800 280" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" style="display: block; min-width: 600px; max-width: 100%;">
      <defs>
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Ovarian Reserve Female Hormone Test Kit</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">At-home fingerprick endocrine assessment quantifying Anti-Müllerian Hormone (AMH), FSH, and estradiol to map reproductive and ovarian biological reserve.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$49.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£39.00 / 45€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B08H7V69F7?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Withings Sleep Analyzer Under-Mattress Pad</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Contactless pneumatometric sleep sensor placed beneath the mattress to track sleep cycles, continuous heart rate, and hormonal phase sleep efficiency.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$129.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£119.99 / 129,95€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B078Z1B34S?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
            <span>Buy on Amazon</span>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
          </a>
          <a href="https://123thenextlevel.com/store" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(15, 23, 42, 0.8); color: #cbd5e1; border: 1px solid rgba(255, 255, 255, 0.12); padding: 0.6rem 1.1rem; border-radius: 0.6rem; font-weight: 600; font-size: 0.825rem; text-decoration: none; transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Zebora Marine Collagen Peptides Powder</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Bioactive collagen peptides targeting pelvic floor elasticity, dermis matrix thickness, and joint recovery across luteal and follicular cycles.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$28.99 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£24.99 / 27,99€)</span></span>
...
<div class="clinical-svg-infographic my-8 p-4 sm:p-6 rounded-2xl border border-slate-800 bg-slate-950/90 shadow-2xl overflow-hidden backdrop-blur-md">
  ...
  <div style="margin-bottom: 0.75rem;">
    <h4 style="margin: 0 0 0.25rem 0; font-size: 1rem; font-weight: 800; color: #f8fafc; font-family: ''Outfit'', sans-serif; letter-spacing: -0.01em;">Environmental Epigenetic Transduction Architecture</h4>
    <p style="margin: 0; font-size: 0.8rem; color: #94a3b8;">Calibrating indoor photons, aerobiology, biophilic acoustics, and thermal radiation for biological regeneration.</p>
  </div>
  <div style="width: 100%; overflow-x: auto;">
    <svg viewBox="0 0 800 280" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" style="display: block; min-width: 600px; max-width: 100%;">
      <defs>
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Eko CORE 500™ Digital AI Stethoscope</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Next-generation digital stethoscope with real-time acoustic amplification and simultaneous 3-lead electrocardiogram for familial health screening.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$429.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£379.00 / 429€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.ekohealth.com/products/core-500-digital-stethoscope" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Portable Full-Body Infrared Sauna Tent</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Far-infrared thermal sanctuary engineered for social bio-resonance, shared recovery routines, and home microclimate optimization.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$249.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£199.99 / 229€)</span></span>
...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Sony WH-CH720N Noise-Canceling Headphones</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Acoustic isolation headset allowing complete control over personal sonic environments and auditory resets in dense urban settings.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$149.99 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£119.00 / 129€)</span></span>
