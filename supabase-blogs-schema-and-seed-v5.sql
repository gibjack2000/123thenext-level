...
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="rower-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">The gold standard for full-body aerobic power and low-impact joint longevity.</p>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="wearable-tracker-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><polyline points="20 6 9 17 4 12"></polyline></svg>
          FDA Approved Heart Monitoring
        </span>
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Multispectral Wearable Biosensor</span>
      </div>
      ...
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Continuous wrist telemetry tracking heart rate variability, ECG rhythm, and recovery readiness.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="reagent-strips-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
    ...
    <div style="flex: 1; min-width: 260px;">
      ...
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Instant 2-minute biochemical test tracking hydration, urine ketones, and kidney health.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="sirtuin-stack-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
      <img src="https://123thenextlevel.com/assets/images/shop/sirtuin-stack.png" alt="Momentous Sirtuin Activation & Cell Recovery Stack" style="max-width: 100%; max-height: 100%; object-fit: contain; filter: drop-shadow(0 6px 12px rgba(0,0,0,0.4));" />
    </div>
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Cellular Epigenetic Stack</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Momentous Sirtuin Activation & Cell Recovery Stack</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Clinically certified Resveratrol, NMN precursors, and Apigenin to protect your cellular software.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="segmental-scale-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Clinical Segmental Hardware</span>
      </div>
      ...
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Tracks visceral fat around organs, vascular arterial age, and segmental muscle balance.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="blood-pressure-cuff-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
      <img src="https://123thenextlevel.com/assets/images/shop/bpm-connect.png" alt="Withings BPM Connect Wi-Fi Cuff" style="max-width: 100%; max-height: 100%; object-fit: contain; filter: drop-shadow(0 6px 12px rgba(0,0,0,0.4));" />
    </div>
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Arterial Telemetry Sensor</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Withings BPM Connect Wi-Fi Cuff</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Medical-grade cardiovascular pressure monitor tracking arterial elasticity and heart safety silently.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="cgm-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
      <img src="https://123thenextlevel.com/assets/images/shop/cgm.png" alt="Continuous Glucose Monitor (Abbott Lingo / Dexcom)" style="max-width: 100%; max-height: 100%; object-fit: contain; filter: drop-shadow(0 6px 12px rgba(0,0,0,0.4));" />
    </div>
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Continuous Metabolic Biosensor</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Continuous Glucose Monitor (Abbott Lingo / Dexcom)</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Real-time interstitial glucose telemetry syncing blood sugar levels directly to your phone.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$89.00 / month <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£79.00 / 79,00€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
  ...
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><polyline points="20 6 9 17 4 12"></polyline></svg>
          FDA Cleared Muscle Telemetry
        </span>
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Visceral Adiposity Scale</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Withings Body Scan Segmental Composition Scale</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Measures visceral fat around internal organs and preserves lean muscle during weight loss.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$399.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£349.99 / 399,95€)</span></span>
  ...
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Rapid Metabolic Diagnostic</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">ALLTEST 10-Parameter Urinary Reagent Strips</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Instant screen tracking urine ketones, kidney load, and metabolic hydration status.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$14.99 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£12.99 / 14,99€)</span></span>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="sleep-analyzer-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><polyline points="20 6 9 17 4 12"></polyline></svg>
          Touch-Free Sleep Science
        </span>
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Zero-Wearable Sleep Sensor</span>
      </div>
      ...
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Contact-free ballistocardiography tracking sleep cycles, nocturnal heart rate, and sleep apnea silently.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
        ...
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B078Z1B34S?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
            <span>Order Sleep Analyzer</span>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
          </a>
          <a href="https://123thenextlevel.com/store" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(15, 23, 42, 0.8); color: #cbd5e1; border: 1px solid rgba(255, 255, 255, 0.12); padding: 0.6rem 1.1rem; border-radius: 0.6rem; font-weight: 600; font-size: 0.825rem; text-decoration: none; transition: all 0.2s ease;">
            <span>Store Hub</span>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="stethoscope-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><polyline points="20 6 9 17 4 12"></polyline></svg>
          FDA Cleared AI Auscultation
        </span>
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Clinical 3-Lead AI Sensor</span>
      </div>
      ...
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Clinical 3-lead ECG and electronic stethoscope detecting cardiac murmurs and rhythm variations in 15 seconds.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$429.00 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£379.00 / 429,00€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
  ...
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Autonomic Cardiovascular Sensor</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Withings BPM Connect Wi-Fi Cuff</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Instant clinical blood pressure and pulse tracking syncing directly to your cardiovascular history.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$99.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£89.99 / 99,95€)</span></span>
  ...
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><polyline points="20 6 9 17 4 12"></polyline></svg>
          FDA Cleared Continuous Sensor
        </span>
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Infradian Metabolic Biosensor</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Continuous Glucose Monitor (Abbott Lingo / Dexcom)</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Maps progesterone-driven insulin sensitivity changes throughout your 28-day cycle in real time.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$89.00 / month <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£79.00 / 79,00€)</span></span>
  ...
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Segmental Bone & Lean Scale</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Withings Body Scan Segmental Composition Scale</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Measures segmental lean muscle mass, visceral fat, and bone mineral density trends.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$399.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£349.99 / 399,95€)</span></span>
  ...
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Mitochondrial Cellular Stack</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Momentous Sirtuin Activation & Cell Recovery Stack</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Mitochondrial antioxidant support preserving ovarian resilience and cellular energy production.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$89.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£79.99 / 89,95€)</span></span>
  ...
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    ...
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        ...
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Zero-Contact Sleep Biosensor</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Withings Sleep Analyzer Under-Mattress Pad</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Zero-wearable contact-free pad logging sleep architecture, resting heart rate, and sleep apnea without wearing devices in bed.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$129.95 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£119.99 / 129,95€)</span></span>
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="sauna-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
      <img src="https://123thenextlevel.com/assets/images/shop/sauna.png" alt="LifePro RejuvaWrap Far-Infrared Sauna Blanket" style="max-width: 100%; max-height: 100%; object-fit: contain; filter: drop-shadow(0 6px 12px rgba(0,0,0,0.4));" />
    </div>
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
      ...
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">LifePro RejuvaWrap Far-Infrared Sauna Blanket</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Far-infrared thermal sanctuary engineered for cellular recovery, deep detoxification, and parasympathetic calm.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$228.46 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£254.99 / 289,99€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B09PSKN6X3?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
...
<!-- Fallback HTML Representation for Static Parsers -->
<div class="product-card-box my-8 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-cyan-500/50" data-product-id="headphones-us" style="margin: 2.25rem 0; padding: 1.5rem; border-radius: 1.25rem; border: 1px solid rgba(255, 255, 255, 0.09); background: rgba(13, 17, 23, 0.85); box-shadow: 0 12px 30px -10px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.08); backdrop-filter: blur(16px);">
  <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 1.5rem; align-items: center;">
    <div style="flex-shrink: 0; width: 140px; height: 140px; border-radius: 1rem; overflow: hidden; background: rgba(2, 6, 23, 0.6); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255, 255, 255, 0.08); padding: 0.5rem;">
      <img src="https://123thenextlevel.com/assets/images/shop/sony-headphones.png" alt="Soundcore by Anker Q20i Hybrid Active Noise Cancelling Headphones" style="max-width: 100%; max-height: 100%; object-fit: contain; filter: drop-shadow(0 6px 12px rgba(0,0,0,0.4));" />
    </div>
    <div style="flex: 1; min-width: 260px;">
      <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
        <span style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.25rem 0.6rem; border-radius: 9999px; background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle;"><polyline points="20 6 9 17 4 12"></polyline></svg>
          Acoustic Sanctuary & Noise Defense
        </span>
        <span style="font-size: 0.75rem; color: #64748b; font-weight: 600;">Acoustic Sanctuary & Noise Defense</span>
      </div>
      <h4 style="margin: 0 0 0.5rem 0; font-size: 1.15rem; font-weight: 800; color: #f8fafc; line-height: 1.3;">Soundcore by Anker Q20i Hybrid Active Noise Cancelling Headphones</h4>
      <p style="margin: 0 0 1rem 0; font-size: 0.875rem; color: #94a3b8; line-height: 1.5;">Acoustic isolation headset allowing complete control over personal sonic environments and auditory resets.</p>
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 0.85rem;">
        <div>
          <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase; font-weight: 600; display: block;">Live Retail & Subscriptions</span>
          <span style="font-size: 1.25rem; font-weight: 800; color: #f8fafc;">$37.98 <span style="font-size: 0.8rem; font-weight: 600; color: #64748b;">(£28.40 / 49,99€)</span></span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <a href="https://www.amazon.com/dp/B0C3HCD34R?tag=123znl0e-20" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; padding: 0.6rem 1.15rem; border-radius: 0.6rem; font-weight: 700; font-size: 0.825rem; text-decoration: none; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.35); transition: all 0.2s ease;">
